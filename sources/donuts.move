/// Unlike `Owned` object, `Shared` ones can be accessed by anyone on the
...
module examples::donuts {
    ...
    fun init(ctx: &mut TxContext) {
        ...
        // Shared the object to make it accessible to everyone!
    ...
    public entry fun buy_donut(shop: &mut DonutShop, payment: &mut Coin<SUI>, ctx: &mut TxContext) {
    ...
    /// Take coin from `DonutShop` and transfer it of tx sender.
